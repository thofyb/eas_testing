def cmd_dump_time(core_i, test_i, folder_name):
    return '~/Android/Sdk/platform-tools/adb shell cat /sys/devices/system/cpu/cpu' + str(core_i) + '/cpufreq/stats/time_in_state > res/' + folder_name + '/time_in_state_' + str(core_i) + '_' + str(test_i) + '.txt'


def cmd_dump_trans(core_i, test_i, folder_name):
    return '~/Android/Sdk/platform-tools/adb shell cat /sys/devices/system/cpu/cpu' + str(core_i) + '/cpufreq/stats/trans_table > res/' + folder_name + '/trans_table_' + str(core_i) + '_' + str(test_i) + '.txt'
...
def cmd_battery_stats_dump(package, test_i, folder_name):
    return '~/Android/Sdk/platform-tools/adb shell dumpsys batterystats --charged ' + package + ' > res/' + folder_name + '/batterystats_' + str(test_i) + '.txt'
...
def cmd_gfxinfo_dump(package, test_i, folder_name):
    return '~/Android/Sdk/platform-tools/adb shell dumpsys gfxinfo ' + package + ' > res/' + folder_name + '/frames_' + str(test_i) + '.txt'
...
def cmd_start_test(test, governor, test_cnt):
    return "~/Android/Sdk/tools/bin/monkeyrunner" + test + " " + str(test_cnt) + " " + governor
