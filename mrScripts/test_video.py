...
for idx in range(3):
    ...
    os.system("adb shell am start -a android.intent.action.VIEW -d file:///sdcard/video.mp4 -t video/mp4")
...
for test_i in range(test_count):
    ...
    device.touch(int(w/2), int(h/2), "DOWN_AND_UP")
    MonkeyRunner.sleep(time_limit - 2)
